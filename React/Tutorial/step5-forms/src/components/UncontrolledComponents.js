  ...
  return (
    <div className="demo-box">
      ...
      <form onSubmit={handleSubmit} style={{ maxWidth: '400px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', margin: '20px 0' }}>
          <button type="submit" className="button">파일 정보 확인</button>
          <button type="button" className="button" onClick={handleReset}>초기화</button>
        </div>
      </form>
        ...
        <div className="form-preview">
          ...
          {uploadedFiles.map((file, index) => (
            <div key={index} style={{ 
              ...
              <p><strong>수정일:</strong> {file.lastModified}</p>
            </div>
          ))}
        </div>
      )}
...
function CheckboxRadioForm() {
  ...
  const handleSubmit = (e) => {
    ...
    // 라디오 버튼 값 수집
    const selectedRadio = radioRefs.current
      .find(ref => ref && ref.checked)?.value || '';
...
function FormDataExample() {
  ...
  return (
    <div className="demo-box">
      ...
      <form ref={formRef} onSubmit={handleSubmit} style={{ maxWidth: '400px', margin: '0 auto' }}>
        <div className="form-group">
        ...
        <div className="form-group">
          ...
          <div className="checkbox-group">
            <div className="checkbox-item">
              <input type="checkbox" id="web" name="interests" value="웹 개발" />
              <label htmlFor="web">웹 개발</label>
            </div>
            <div className="checkbox-item">
              <input type="checkbox" id="mobile" name="interests" value="모바일 개발" />
...
function UncontrolledComponents() {
  return (
    <div className="component-section">
      ...
      <p>
        비제어 컴포넌트는 DOM 요소가 직접 값을 관리하는 폼 요소입니다.
        useRef를 통해 DOM에 접근하여 값을 가져오거나 설정할 수 있습니다.
      </p>

      <div className="code-example">
        <strong>비제어 컴포넌트 기본 패턴:</strong><br/>
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="code-example">
        <strong>비제어 컴포넌트 사용 시기:</strong><br/>
        {`// 1. 파일 업로드
const fileRef = useRef();
...
<RichTextEditor ref={editorRef} />`}
      ...
      <div className="highlight">
        ...
        <ul style={{ textAlign: 'left', display: 'inline-block' }}>
          <li><strong>제어 컴포넌트:</strong> 실시간 검증, 복잡한 상태 관리</li>
          <li><strong>비제어 컴포넌트:</strong> 간단한 폼, 파일 업로드, 성능 중요</li>
          <li><strong>혼합 사용:</strong> 폼의 특성에 따라 적절히 선택</li>
          <li><strong>일관성:</strong> 프로젝트 내에서 일관된 패턴 사용</li>
        </ul>
      </div>
    </div>
  );
