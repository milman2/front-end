      ...
      <form onSubmit={handleSubmit} style={{ maxWidth: '500px', margin: '0 auto' }}>
        ...
        <div className="form-group">
          ...
          <div className="checkbox-group">
            {['React', 'Vue', 'Angular', 'Svelte', 'Next.js', 'Nuxt.js'].map((framework) => (
          ...
          <div style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>
            선택된 프레임워크: {formData.multipleCheckboxes.join(', ') || '없음'}
          </div>
        </div>
...
function InputTypes() {
  return (
    <div className="component-section">
      ...
      <p>
        HTML5의 다양한 입력 타입들을 React에서 효과적으로 처리하는 방법을 익혀보세요.
        각 입력 타입의 특성에 맞는 상태 관리와 이벤트 처리를 구현합니다.
      </p>

      <div className="code-example">
        <strong>다양한 입력 타입 처리 패턴:</strong><br/>
        {`function InputTypesDemo() {
  const [formData, setFormData] = useState({
    text: '',
    email: '',
    ...
    <form>
      ...
      <div className="highlight">
        ...
        <ul style={{ textAlign: 'left', display: 'inline-block' }}>
          <li><strong>텍스트 입력:</strong> value와 onChange 사용</li>
          <li><strong>체크박스:</strong> checked와 onChange 사용</li>
          <li><strong>라디오 버튼:</strong> checked와 value 비교</li>
          <li><strong>파일 입력:</strong> files 배열에서 파일 추출</li>
          <li><strong>다중 선택:</strong> selectedOptions 배열 처리</li>
          <li><strong>숫자 입력:</strong> min, max, step 속성 활용</li>
        </ul>
      </div>

      <div className="code-example">
        <strong>특수 입력 타입 처리:</strong><br/>
        {`// 1. 파일 업로드
...
const handleTagsInput = (e) => {
  ...
  setTags(tags);
      ...
      <div className="highlight">
        ...
        <ul style={{ textAlign: 'left', display: 'inline-block' }}>
          <li><strong>text:</strong> 일반 텍스트 입력</li>
          <li><strong>email:</strong> 이메일 주소 (브라우저 검증)</li>
          <li><strong>password:</strong> 비밀번호 (마스킹)</li>
          <li><strong>number:</strong> 숫자 입력 (스피너 제공)</li>
          <li><strong>tel:</strong> 전화번호 (모바일 키패드)</li>
          <li><strong>url:</strong> URL 입력 (브라우저 검증)</li>
          <li><strong>date/time:</strong> 날짜/시간 선택기</li>
          <li><strong>color:</strong> 색상 선택기</li>
          <li><strong>range:</strong> 슬라이더</li>
          <li><strong>file:</strong> 파일 선택</li>
        </ul>
      </div>
    </div>
  );
