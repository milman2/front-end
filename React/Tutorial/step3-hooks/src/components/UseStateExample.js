...
function Counter() {
  ...
  return (
    <div className="demo-box">
      ...
      <button className="button" onClick={reset}>리셋</button>
    </div>
  );
}
  ...
  return (
    <div className="component-section">
      ...
      <p>
        ...
        컴포넌트의 상태를 관리하고, 상태가 변경될 때 컴포넌트를 리렌더링합니다.
      </p>

      <div className="code-example">
        <strong>useState 기본 문법:</strong><br/>
        {`import React, { useState } from 'react';
...
function MyComponent() {
  ...
  return (
    <div>
      ...
      <div className="code-example">
        <strong>함수형 업데이트와 객체/배열 상태:</strong><br/>
        {`// 함수형 업데이트
