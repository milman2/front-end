...
function LifecycleLogger() {
  ...
  return (
    <div className='demo-box'>
      <h3>컴포넌트 생명주기 추적</h3>
      <p>
        컴포넌트의 마운트, 업데이트, 언마운트 과정을 실시간으로 확인해보세요.
      </p>
...
function ComponentLifecycle() {
  return (
    <div className='component-section'>
      ...
      <p>
        React 컴포넌트는 생성(마운트), 업데이트, 제거(언마운트)의 생명주기를
        가집니다. useEffect를 통해 각 단계에서 필요한 작업을 수행할 수 있습니다.
      </p>
  ...
  return <div>카운트: {count}</div>;
      ...
      <div className='highlight'>
        ...
        <ul style={{ textAlign: 'left', display: 'inline-block' }}>
          <li>
            <strong>마운트:</strong> 컴포넌트가 DOM에 추가됨
          </li>
          <li>
            <strong>업데이트:</strong> Props나 State가 변경됨
          </li>
          <li>
            <strong>언마운트:</strong> 컴포넌트가 DOM에서 제거됨
          </li>
          <li>
            <strong>클린업:</strong> 메모리 누수 방지를 위한 정리 작업
          </li>
        </ul>
      </div>
