  ...
  return (
    <div className='demo-box'>
      ...
      {loading && retryCount === 0 && (
        <p className='status loading'>로딩 중...</p>
      )}
      {error && <p className='status error'>{error}</p>}
      {data && !loading && (
        <div className='user-card'>
...
function APICallPatterns() {
  return (
    <div className='component-section'>
      ...
      <p>
        React에서 API 호출을 처리하는 다양한 패턴을 익혀보세요. 로딩 상태, 에러
        처리, 요청 취소 등을 포함한 실전 패턴들을 다룹니다.
      </p>
    ...
    <div>
      ...
      <div className='highlight'>
        ...
        <ul style={{ textAlign: 'left', display: 'inline-block' }}>
          <li>
            <strong>로딩 상태:</strong> 사용자에게 진행 상황 표시
          </li>
          <li>
            <strong>에러 처리:</strong> 적절한 에러 메시지 제공
          </li>
          <li>
            <strong>요청 취소:</strong> AbortController로 불필요한 요청 취소
          </li>
          <li>
            <strong>재시도 로직:</strong> 네트워크 오류 시 자동 재시도
          </li>
          <li>
            <strong>상태 관리:</strong> 여러 API 호출 상태 분리
          </li>
        </ul>
      </div>
